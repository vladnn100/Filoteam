...
public class ArbolGeneral<T> {
    ...
    public String postOrden2(NodoArbol<PlantaCafe> n) {
        //String mos = "";
        if (n != null) {
            NodoArbol<PlantaCafe> c;
            for (c = n.hijo; c != null; c = c.hermano) {
            ...
            mos = (mos + n.info.nombre + "--");
        }
        return mos;
    }

    public String inOrden2(NodoArbol<PlantaCafe> n) {
        //String mos = "";
        if (n != null) {
            NodoArbol<PlantaCafe> c = n.hijo;
            if (c != null) {
    ...
    public String preOrden2(NodoArbol<PlantaCafe> n){
        //String mos = "";
        if(n != null){
            mos = (mos + n.info.nombre + "--");
            for(n = n.hijo;n != null;n = n.hermano) {
